            ...
            <div className={classes.drawSet}>
              <Card className={classes.card}>
                <CardContent>
                  ...
                  <Tooltip title="一つ前へ">
                    <IconButton className={classes.submitBtn} onClick={undo}>
                      <FaUndo size="2rem" />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="一つ先へ">
                    <IconButton className={classes.submitBtn} onClick={redo}>
                      <FaRedo size="2rem" />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="パレット">
                  ...
                  <SelectBox
                    ...
                    setOption={setTheme}
                  />
                  <UploadButton uploadCanvas={uploadPicture} theme={theme}>
                    アップロードする
                  </UploadButton>
                </CardContent>
              </Card>
